...
import { widerspruecheFindenText } from "../../lib/texts";
import Header from "../../components/Header";
import InfoText from "../../components/InfoText";
import InputWithAdd from "../../components/InputWithAdd";

export default function WiderspruecheScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Header headerText="Widersprüche finden" />
      <ScrollView>
        {showInfo ? (
          <InfoText text={widerspruecheFindenText} />
        ) : (
          <View>
            <View>
              <InputWithAdd
                placeHolder="Platz für Widersprüche"
